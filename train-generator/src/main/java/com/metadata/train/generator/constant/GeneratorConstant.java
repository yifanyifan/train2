...
package com.metadata.train.generator.constant;
...
public interface GeneratorConstant {
     ...
     * 分页参数父类全称，带包名
     */
    String SUPER_PAGE_PARAM_CLASS = "com.metadata.train.entity.common.BasePageParam";
    /**
     * 分页排序参数父类全称，带包名
     */
     ...
     * 分页对象类全称，带包名
     */
    String PAGING_CLASS = "com.metadata.train.entity.common.PageEntity";
    /**
     * 分页信息类全称，带包名
     */
     ...
     * 公共结果类全称，带包名
     */
    String API_RESULT_CLASS = "com.metadata.train.common.ResultEntity";
    /**
     * 分组验证Add.class类路径
     */
    String VALIDATOR_ADD_PACKAGE = "com.metadata.train.validator.groups.Add";
    /**
     * 分组验证Update.class类路径
     */
    String VALIDATOR_UPDATE_PACKAGE = "com.metadata.train.validator.groups.Update";
}
